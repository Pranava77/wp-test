...
function webfixus_scaffold() {
	...
	update_option( 'webfixus_scaffold_version', WEBFIXUS_SCAFFOLD_VERSION );
}
...
function webfixus_maybe_refresh() {
	...
	if ( WEBFIXUS_SCAFFOLD_VERSION !== $done || ! $home ) {
		webfixus_scaffold();
	}
}
...
function webfixus_elementor_notice() {
	...
	echo '<div class="notice notice-warning"><p><strong>WEBFIXUS:</strong> install &amp; activate the free <em>Elementor</em> plugin to edit your pages visually. Your pages already display without it.</p></div>';
}
